...
//            }, 5000);
    ...
    public void openInstagramProfile(View view) {
        // Replace "username" with the actual Instagram username you want to open

        // Instagram profile URL
        String url = "https://www.instagram.com/weeho_events/";

        // Create an Intent with the ACTION_VIEW to open the URL
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(url));

        // Check if the Instagram app is installed; if not, open in a web browser
        ...
        try {
            ...
            // Instagram app is not installed, open in a web browser
        ...
        // Instagram profile URL
        String url = "https://www.facebook.com/weehoevents";
        ...
        // Instagram profile URL
        String url = "https://www.linkedin.com/in/weehoevents/";
        ...
        // Instagram profile URL
        String url = "https://twitter.com/Weeho_Moments";
